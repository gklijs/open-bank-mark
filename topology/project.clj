(defproject nl.openweb/topology "0.1.0-SNAPSHOT"
  ...
  :dependencies [[clj-time "0.15.1"]
                 ...
                 [io.confluent/kafka-avro-serializer :version :exclusions [org.apache.avro/avro io.netty/netty org.slf4j/slf4j-log4j12 com.fasterxml.jackson.core/jackson-core]]
                 [org.apache.avro/avro :version]
                 [org.apache.kafka/kafka-clients "2.2.0" :exclusions [org.apache.avro/avro]]
  ...
  :aot :all
  :profiles {:provided {:dependencies [[org.apache.avro/avro-compiler "1.9.0"]]
